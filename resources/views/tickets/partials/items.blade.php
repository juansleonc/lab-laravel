<div data-id="25" class="well well-sm request">
    ...
    <p>
        ...
        <a href="#" class="btn btn-hight btn-unvote hide">dd
        ...
        <a href="{{ route('tickets.details', $ticket) }}">
            ...
            - <span class="comments-count">{{ $ticket->_num_comments }} comentarios</span>.
        </a>
        <p class="date-t"><span class="glyphicon glyphicon-time"></span>{{ $ticket->created_at->format('d-m-Y h:i:a') }} Por {{ $ticket->author->name }}</p>
